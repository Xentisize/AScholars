...
export default function Course({ courseName, courseDescription, courseImgUrl }) {
		...
		<>
			<div className="flex items-center justify-center rounded-lg">
				<button type="button" onClick={openModal}>
					<img src={"/courses/" + courseImgUrl} className="h-48 w-auto shadow-lg rounded-lg ring-indigo-200 ring-4" />
					<span className="mt-3 block font-semibold rounded-lg">{courseName}</span>
				</button>
			</div>
							...
							>
								<Dialog.Panel className="w-2/3 transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
									...
									<div className="mt-2">
										...
										<img src={"/courses/" + courseImgUrl} alt="course cover image" className="w-full" />
									</div>
